...
\todo[inline]{Kriterien formulieren und finden}
% - Dürfen sich nicht widersprechen
% - müssen zur Aufgabe passen
% - sollten möglichst konkret formuliert werden

Beim Anwenden der Kriterien zur Bewertung von Ideen müssen zunächst die Randbedingungen angewandt werden. 
...
\begin{itemize}
    \item Punktekleben (Siehe in Kapitel \todo[inline] {Verweis auf subsection in einer anderen section})
